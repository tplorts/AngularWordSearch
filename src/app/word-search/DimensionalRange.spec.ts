...
describe('Range1D', () => {
  ...
  it('should span from 0 to 9', () => {
    // delta of 0 means the direction is perpendicular to this dimension,
    // so the word should occupy 1 unit of this dimension.
    // The length should be irrelevant in any perpendicular case.
    const range = new Range1D(10, 0, 1);
